...
#                         meta.append([
#                             [
#                                 'Label', 'Code', 'Time started',
#                                 'Trials order', 'Error percentage'
#                             ],
#                             [
#                                 label, code, time_started
#                             ]

#                         ])

#                         # Second batch of data (actual IAT results).
#                         data = line[line.find('"'):line.rfind('}",') + 3]
...
#                             print(data)
#                         except Exception as e:
#                             print('crashed -- ast.literal_eval(data)')
#                             print(e)
...
#                             meta[count][1].append(data['error_percentage'])
#                         except Exception as e:
#                             print('crashed -- Get more metadata')
#                             print(e)
...
#                                 ])
#                         except Exception as e:
#                             print('crashed -- Process regular trials results')
#                             print(e)
